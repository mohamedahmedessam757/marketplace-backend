...
export class OrderStateMachine {
    ...
    private readonly TRANSITION_RULES: Record<OrderStatus, OrderStatus[]> = {
        ...
        [OrderStatus.PARTIALLY_SHIPPED]: [OrderStatus.PARTIALLY_SHIPPED, OrderStatus.SHIPPED, OrderStatus.PARTIALLY_DELIVERED, OrderStatus.DELIVERED, OrderStatus.CANCELLED],
        ...
        [OrderStatus.SHIPPED]: [OrderStatus.DELIVERED, OrderStatus.PARTIALLY_DELIVERED, OrderStatus.RETURNED, OrderStatus.DISPUTED],
        [OrderStatus.PARTIALLY_DELIVERED]: [OrderStatus.DELIVERED, OrderStatus.PARTIALLY_DELIVERED, OrderStatus.COMPLETED, OrderStatus.DISPUTED, OrderStatus.RETURN_REQUESTED, OrderStatus.RETURNED],
